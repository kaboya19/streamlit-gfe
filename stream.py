...
if page=="Özel Kapsamlı Endeksler":
    ...
    for col in tüik.columns:
        ...
        göstergeaylık[col].iloc[-1]=(((hareketli_aylik_ortalama(özelgöstergeler[col])["Aylık Ortalama"].fillna(method="ffill").iloc[-1]/hareketli_aylik_ortalama(özelgöstergeler[col])["Aylık Ortalama"].loc[f"{oncekiyear}-{tarihim}-24"]))-1)*100

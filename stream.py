...
if page=="Özel Kapsamlı Endeksler":
    ...
    for col in tüik.columns:
        ...
        göstergeaylık[col].iloc[-1]=(hareketli_aylik_ortalama(özelgöstergeler[col])["Aylık Ortalama"].iloc[-1]/hareketli_aylik_ortalama(özelgöstergeler[col])["Aylık Ortalama"].loc[f"{oncekiyear}-{onceki}-{tarihim}"])
